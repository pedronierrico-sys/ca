...
4. puoi forzare il backend passando `?apiBase=http://127.0.0.1:8000` nella URL della pagina oppure impostando API base direttamente nel campo UI,
5. verifica rapidamente backend con `http://127.0.0.1:8000/api/health` (deve rispondere JSON con `status: ok`).
